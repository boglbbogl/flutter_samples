...
import 'package:tdd_books/domain/entities/book.dart' as _i2;
import 'package:tdd_books/domain/repositories/book_repository.dart' as _i4;
...
class MockBookRepository extends _i1.Mock implements _i4.BookRepository {
  ...
  @override
  _i5.Future<_i2.Book> getSearchBooks(String? query) => (super.noSuchMethod(
        Invocation.method(
          #getSearchBooks,
          [query],
        ),
        returnValue: _i5.Future<_i2.Book>.value(_FakeBook_0(
          this,
          Invocation.method(
            #getSearchBooks,
            [query],
