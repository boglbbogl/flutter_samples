...
// in tdd_weather/test/helpers/test_helper.dart.
...
import 'package:tdd_weather/core/error/failure.dart' as _i7;
import 'package:tdd_weather/data/data_sources/remote_data_source.dart' as _i9;
import 'package:tdd_weather/data/models/weather_model.dart' as _i3;
import 'package:tdd_weather/domain/entities/weather.dart' as _i8;
import 'package:tdd_weather/domain/repositories/weather_repository.dart' as _i5;
...
class MockWeatherRemoteDataSource extends _i1.Mock
  ...
  @override
  _i6.Future<_i3.WeatherModel> getCurrentWeather(String? name) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
          [name],
