...
// in mockito_sample/test/helper/test_helper.dart.
...
import 'package:mockito_sample/image/image_data.dart' as _i5;
import 'package:mockito_sample/image/image_repository.dart' as _i3;
...
class MockImageRepository extends _i1.Mock implements _i3.ImageRepository {
  ...
  @override
  _i4.Future<_i5.ImageData?> fetch(int? no) => (super.noSuchMethod(
        Invocation.method(
          #fetch,
          [no],
        ),
        returnValue: _i4.Future<_i5.ImageData?>.value(),
      ) as _i4.Future<_i5.ImageData?>);
}
